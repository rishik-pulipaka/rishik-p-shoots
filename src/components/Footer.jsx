...
const Footer = () => {
  return (
    <div id="footer-container" className="mt-[100px] p-[5px] w-full h-[200px] bg-[#3B3B3B] text-white flex flex-col justify-evenly items-center inset-x-0 bottom-0 font-montserrat">
        ...
        <div id="copyright-container" className="self-center mt-12 text-base text-center text-white tracking-[2.85px] max-md:mt-10">
